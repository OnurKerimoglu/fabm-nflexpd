...
!BOP
!
! !MODULE: NflexPD_nut - Fennel & Neumann 1996 NPZD model - nutrient component
!
! !INTERFACE:
   module NflexPD_nut
!
...
! !PUBLIC DERIVED TYPES:
   type,extends(type_base_model),public :: type_NflexPD_nut
...
!
! !DESCRIPTION:
!  Here, the NflexPD_nut namelist is read and te variables exported
!  by the model are registered with FABM.
!
! !INPUT PARAMETERS:
   class (type_NflexPD_nut), intent(inout), target :: self
