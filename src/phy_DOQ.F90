...
!BOP
!
! !MODULE: PMbench - DOQ (Dynamically Optimized Quota) phytoplankton component
! Original Authors: O. Kerimoglu 20181204
!
! !INTERFACE:
   module PMbench_phy_DOQ
!
! !DESCRIPTION:
!
! !USES:
...
! !PUBLIC DERIVED TYPES:
   type,extends(type_base_model),public :: type_PMbench_phy_DOQ
...
!
! !DESCRIPTION:
!  Here, the PMbench_phy_DOQ namelist is read and variables exported
!  by the model are registered with FABM.
!
! !INPUT PARAMETERS:
   class (type_PMbench_phy_DOQ), intent(inout), target :: self
...
!
! !INPUT PARAMETERS:
   class (type_PMbench_phy_DOQ), intent(in) :: self
